...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__block_block_js__ = __webpack_require__(3);
/**
 * Gutenberg Blocks
 *
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_site_search__ = __webpack_require__(9);
/**
...
class SiteSearch extends Component {
	constructor() {
		super(...arguments);
		this.searchSites = Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["throttle"])(this.searchSites.bind(this), 500);
		this.state = {
			availableSites: [],
			selectedSiteId: 0
		};
	...
	render() {
		...
		const onSelect = newSelected => {
			...
			const selectedSite = Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["find"])(availableSites, site => {
